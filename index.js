...
// var data = 'Dashboard';
// String mai aap kahi andar nahi ghus sakte dot operator use karke that,s why we use json 
...
app.get('/', async(req, res) => {
  //res.render('index',{data}); // this is how you send data from server to file
  await resData(coinName);
  res.render('index',{mData,mChart,coinName});
})

app.post('/', async(req, res) => {
  //coinName = req.body["selectCoin"]; when using get
  coinName = req.body.selectCoin;// when using post
  await resData(coinName)
  res.render('index',{mData,mChart,coinName})
})
